...
import java.util.List;
    ...
    public class RequestNotImageActivity extends MainActivity {
        ...
        public class DownloadTask extends AsyncTask<URL, Integer, Long> {
            ...
            protected void onPostExecute(Long result) {
                ...
                if (photoList == null) {
                    ...
                    PhotoListAdapter adapter = new PhotoListAdapter(RequestNotImageActivity.this);
        ...
        View.OnClickListener onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(RequestNotImageActivity.this, MainActivity.class);
