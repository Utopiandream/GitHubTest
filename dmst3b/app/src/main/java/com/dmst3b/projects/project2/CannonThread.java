        ...
        while (threadIsRunning) {
            try {
                ...
                synchronized (surfaceHolder) {
                    ...
                    cannonView.totalElapsedTime += elapsedTimeMS / 1000;
                    if(cannonView.level == 2 || cannonView.level == 4 ){
                        cannonView.updatePositions2(elapsedTimeMS); // update game state
                    }
                    else if(cannonView.level == 3){
                        cannonView.updatePositions3(elapsedTimeMS); // update game state
                    }
                    else if(cannonView.level == 1){
